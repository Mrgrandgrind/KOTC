...
static struct FScriptStruct_AkAudio_StaticRegisterNativesFAkAmbSoundCheckpointRecord
{
	...
	IMPLEMENT_CLASS(AAkAmbientSound, 2727323146);
	...
	IMPLEMENT_CLASS(UAkComponent, 1664381660);
	...
	IMPLEMENT_CLASS(UAkGameplayStatics, 1541910831);
	void AAkReverbVolume::StaticRegisterNativesAAkReverbVolume()
	{
	}
	IMPLEMENT_CLASS(AAkReverbVolume, 635012485);
	void UAkSettings::StaticRegisterNativesUAkSettings()
	{
	}
	IMPLEMENT_CLASS(UAkSettings, 2424102391);
...
class UScriptStruct* FMovieSceneAkAudioEventTemplate::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern AKAUDIO_API class UScriptStruct* Z_Construct_UScriptStruct_FMovieSceneAkAudioEventTemplate();
...
class UScriptStruct* FMovieSceneAkAudioRTPCTemplate::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern AKAUDIO_API class UScriptStruct* Z_Construct_UScriptStruct_FMovieSceneAkAudioRTPCTemplate();
...
class UScriptStruct* FMovieSceneAkAudioRTPCSectionData::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern AKAUDIO_API class UScriptStruct* Z_Construct_UScriptStruct_FMovieSceneAkAudioRTPCSectionData();
...
// Cross Module References
	...
	AKAUDIO_API class UScriptStruct* Z_Construct_UScriptStruct_FMovieSceneAkAudioEventTemplate();
	AKAUDIO_API class UScriptStruct* Z_Construct_UScriptStruct_FMovieSceneAkAudioRTPCTemplate();
	AKAUDIO_API class UScriptStruct* Z_Construct_UScriptStruct_FMovieSceneAkAudioRTPCSectionData();
	...
	UFunction* Z_Construct_UFunction_AAkAmbientSound_StartAmbientSound()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("StartAmbientSound"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04020409, 65535);
			ReturnFunction->Bind();
	...
	UFunction* Z_Construct_UFunction_AAkAmbientSound_StopAmbientSound()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("StopAmbientSound"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04020409, 65535);
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
...
PRAGMA_DISABLE_DEPRECATION_WARNINGS
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(AutoPost, AAkAmbientSound, bool);
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_AAkAmbientSound_StartAmbientSound(), "StartAmbientSound"); // 1839522423
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_AAkAmbientSound_StopAmbientSound(), "StopAmbientSound"); // 2777989859
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
	...
	UFunction* Z_Construct_UFunction_UAkComponent_GetAttenuationRadius()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("GetAttenuationRadius"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x5C020C08, 65535, sizeof(AkComponent_eventGetAttenuationRadius_Parms));
	...
	UFunction* Z_Construct_UFunction_UAkComponent_PostAkEvent()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("PostAkEvent"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04020409, 65535, sizeof(AkComponent_eventPostAkEvent_Parms));
	...
	UFunction* Z_Construct_UFunction_UAkComponent_PostAkEventByName()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("PostAkEventByName"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04020409, 65535, sizeof(AkComponent_eventPostAkEventByName_Parms));
	...
	UFunction* Z_Construct_UFunction_UAkComponent_PostAssociatedAkEvent()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("PostAssociatedAkEvent"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04020409, 65535, sizeof(AkComponent_eventPostAssociatedAkEvent_Parms));
	...
	UFunction* Z_Construct_UFunction_UAkComponent_PostTrigger()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("PostTrigger"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04020409, 65535, sizeof(AkComponent_eventPostTrigger_Parms));
	...
	UFunction* Z_Construct_UFunction_UAkComponent_SetActiveListeners()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("SetActiveListeners"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x0C020C08, 65535, sizeof(AkComponent_eventSetActiveListeners_Parms));
	...
	UFunction* Z_Construct_UFunction_UAkComponent_SetAttenuationScalingFactor()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("SetAttenuationScalingFactor"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x0C020C08, 65535, sizeof(AkComponent_eventSetAttenuationScalingFactor_Parms));
	...
	UFunction* Z_Construct_UFunction_UAkComponent_SetOutputBusVolume()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("SetOutputBusVolume"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04020409, 65535, sizeof(AkComponent_eventSetOutputBusVolume_Parms));
	...
	UFunction* Z_Construct_UFunction_UAkComponent_SetRTPCValue()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("SetRTPCValue"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04020409, 65535, sizeof(AkComponent_eventSetRTPCValue_Parms));
	...
	UFunction* Z_Construct_UFunction_UAkComponent_SetStopWhenOwnerDestroyed()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("SetStopWhenOwnerDestroyed"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04020409, 65535, sizeof(AkComponent_eventSetStopWhenOwnerDestroyed_Parms));
	...
	UFunction* Z_Construct_UFunction_UAkComponent_SetSwitch()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("SetSwitch"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04020409, 65535, sizeof(AkComponent_eventSetSwitch_Parms));
	...
	UFunction* Z_Construct_UFunction_UAkComponent_Stop()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("Stop"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04020409, 65535);
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
	...
	UFunction* Z_Construct_UFunction_UAkComponent_UseReverbVolumes()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("UseReverbVolumes"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04020409, 65535, sizeof(AkComponent_eventUseReverbVolumes_Parms));
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UAkComponent_GetAttenuationRadius(), "GetAttenuationRadius"); // 4143566147
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UAkComponent_PostAkEvent(), "PostAkEvent"); // 933353773
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UAkComponent_PostAkEventByName(), "PostAkEventByName"); // 743880252
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UAkComponent_PostAssociatedAkEvent(), "PostAssociatedAkEvent"); // 2018156142
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UAkComponent_PostTrigger(), "PostTrigger"); // 4075372157
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UAkComponent_SetActiveListeners(), "SetActiveListeners"); // 1001163652
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UAkComponent_SetAttenuationScalingFactor(), "SetAttenuationScalingFactor"); // 3566912126
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UAkComponent_SetOutputBusVolume(), "SetOutputBusVolume"); // 898621967
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UAkComponent_SetRTPCValue(), "SetRTPCValue"); // 2158571891
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UAkComponent_SetStopWhenOwnerDestroyed(), "SetStopWhenOwnerDestroyed"); // 2980472544
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UAkComponent_SetSwitch(), "SetSwitch"); // 198471532
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UAkComponent_Stop(), "Stop"); // 2200151399
				...
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UAkComponent_UseReverbVolumes(), "UseReverbVolumes"); // 3702088828
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
	...
	UFunction* Z_Construct_UFunction_UAkGameplayStatics_AddOutputCaptureMarker()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("AddOutputCaptureMarker"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04022409, 65535, sizeof(AkGameplayStatics_eventAddOutputCaptureMarker_Parms));
	...
	UFunction* Z_Construct_UFunction_UAkGameplayStatics_ClearBanks()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("ClearBanks"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04022409, 65535);
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
	...
	UFunction* Z_Construct_UFunction_UAkGameplayStatics_GetAkComponent()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("GetAkComponent"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04822409, 65535, sizeof(AkGameplayStatics_eventGetAkComponent_Parms));
	...
	UFunction* Z_Construct_UFunction_UAkGameplayStatics_LoadBank()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("LoadBank"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04022409, 65535, sizeof(AkGameplayStatics_eventLoadBank_Parms));
	...
	UFunction* Z_Construct_UFunction_UAkGameplayStatics_LoadBankByName()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("LoadBankByName"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04022409, 65535, sizeof(AkGameplayStatics_eventLoadBankByName_Parms));
	...
	UFunction* Z_Construct_UFunction_UAkGameplayStatics_LoadBanks()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("LoadBanks"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04422409, 65535, sizeof(AkGameplayStatics_eventLoadBanks_Parms));
	...
	UFunction* Z_Construct_UFunction_UAkGameplayStatics_LoadInitBank()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("LoadInitBank"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04022409, 65535);
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
	...
	UFunction* Z_Construct_UFunction_UAkGameplayStatics_PostEvent()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("PostEvent"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04022409, 65535, sizeof(AkGameplayStatics_eventPostEvent_Parms));
	...
	UFunction* Z_Construct_UFunction_UAkGameplayStatics_PostEventAtLocation()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("PostEventAtLocation"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04822409, 65535, sizeof(AkGameplayStatics_eventPostEventAtLocation_Parms));
	...
	UFunction* Z_Construct_UFunction_UAkGameplayStatics_PostEventAtLocationByName()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("PostEventAtLocationByName"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04822409, 65535, sizeof(AkGameplayStatics_eventPostEventAtLocationByName_Parms));
	...
	UFunction* Z_Construct_UFunction_UAkGameplayStatics_PostEventAttached()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("PostEventAttached"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04022409, 65535, sizeof(AkGameplayStatics_eventPostEventAttached_Parms));
	...
	UFunction* Z_Construct_UFunction_UAkGameplayStatics_PostEventByName()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("PostEventByName"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04022409, 65535, sizeof(AkGameplayStatics_eventPostEventByName_Parms));
	...
	UFunction* Z_Construct_UFunction_UAkGameplayStatics_PostTrigger()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("PostTrigger"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04022409, 65535, sizeof(AkGameplayStatics_eventPostTrigger_Parms));
	...
	UFunction* Z_Construct_UFunction_UAkGameplayStatics_SetOcclusionRefreshInterval()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("SetOcclusionRefreshInterval"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04022409, 65535, sizeof(AkGameplayStatics_eventSetOcclusionRefreshInterval_Parms));
	...
	UFunction* Z_Construct_UFunction_UAkGameplayStatics_SetOutputBusVolume()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("SetOutputBusVolume"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04022409, 65535, sizeof(AkGameplayStatics_eventSetOutputBusVolume_Parms));
	...
	UFunction* Z_Construct_UFunction_UAkGameplayStatics_SetRTPCValue()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("SetRTPCValue"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04022409, 65535, sizeof(AkGameplayStatics_eventSetRTPCValue_Parms));
	...
	UFunction* Z_Construct_UFunction_UAkGameplayStatics_SetState()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("SetState"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04022409, 65535, sizeof(AkGameplayStatics_eventSetState_Parms));
	...
	UFunction* Z_Construct_UFunction_UAkGameplayStatics_SetSwitch()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("SetSwitch"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04022409, 65535, sizeof(AkGameplayStatics_eventSetSwitch_Parms));
	...
	UFunction* Z_Construct_UFunction_UAkGameplayStatics_SpawnAkComponentAtLocation()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("SpawnAkComponentAtLocation"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04822409, 65535, sizeof(AkGameplayStatics_eventSpawnAkComponentAtLocation_Parms));
	...
	UFunction* Z_Construct_UFunction_UAkGameplayStatics_StartAllAmbientSounds()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("StartAllAmbientSounds"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04022409, 65535, sizeof(AkGameplayStatics_eventStartAllAmbientSounds_Parms));
	...
	UFunction* Z_Construct_UFunction_UAkGameplayStatics_StartOutputCapture()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("StartOutputCapture"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04022409, 65535, sizeof(AkGameplayStatics_eventStartOutputCapture_Parms));
	...
	UFunction* Z_Construct_UFunction_UAkGameplayStatics_StartProfilerCapture()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("StartProfilerCapture"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04022409, 65535, sizeof(AkGameplayStatics_eventStartProfilerCapture_Parms));
	...
	UFunction* Z_Construct_UFunction_UAkGameplayStatics_StopActor()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("StopActor"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04022409, 65535, sizeof(AkGameplayStatics_eventStopActor_Parms));
	...
	UFunction* Z_Construct_UFunction_UAkGameplayStatics_StopAll()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("StopAll"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04022409, 65535);
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
	...
	UFunction* Z_Construct_UFunction_UAkGameplayStatics_StopAllAmbientSounds()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("StopAllAmbientSounds"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04022409, 65535, sizeof(AkGameplayStatics_eventStopAllAmbientSounds_Parms));
	...
	UFunction* Z_Construct_UFunction_UAkGameplayStatics_StopOutputCapture()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("StopOutputCapture"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04022409, 65535);
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
	...
	UFunction* Z_Construct_UFunction_UAkGameplayStatics_StopProfilerCapture()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("StopProfilerCapture"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04022409, 65535);
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
	...
	UFunction* Z_Construct_UFunction_UAkGameplayStatics_UnloadBank()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("UnloadBank"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04022409, 65535, sizeof(AkGameplayStatics_eventUnloadBank_Parms));
	...
	UFunction* Z_Construct_UFunction_UAkGameplayStatics_UnloadBankByName()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("UnloadBankByName"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04022409, 65535, sizeof(AkGameplayStatics_eventUnloadBankByName_Parms));
	...
	UFunction* Z_Construct_UFunction_UAkGameplayStatics_UseReverbVolumes()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("UseReverbVolumes"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04022409, 65535, sizeof(AkGameplayStatics_eventUseReverbVolumes_Parms));
	...
	UClass* Z_Construct_UClass_UAkGameplayStatics()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UAkGameplayStatics_AddOutputCaptureMarker(), "AddOutputCaptureMarker"); // 1852622533
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UAkGameplayStatics_ClearBanks(), "ClearBanks"); // 434557264
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UAkGameplayStatics_GetAkComponent(), "GetAkComponent"); // 181049712
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UAkGameplayStatics_LoadBank(), "LoadBank"); // 2800327552
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UAkGameplayStatics_LoadBankByName(), "LoadBankByName"); // 1815443697
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UAkGameplayStatics_LoadBanks(), "LoadBanks"); // 1581046777
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UAkGameplayStatics_LoadInitBank(), "LoadInitBank"); // 3286223354
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UAkGameplayStatics_PostEvent(), "PostEvent"); // 3021133355
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UAkGameplayStatics_PostEventAtLocation(), "PostEventAtLocation"); // 1561203685
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UAkGameplayStatics_PostEventAtLocationByName(), "PostEventAtLocationByName"); // 401963240
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UAkGameplayStatics_PostEventAttached(), "PostEventAttached"); // 2718460836
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UAkGameplayStatics_PostEventByName(), "PostEventByName"); // 361931622
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UAkGameplayStatics_PostTrigger(), "PostTrigger"); // 2547492483
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UAkGameplayStatics_SetOcclusionRefreshInterval(), "SetOcclusionRefreshInterval"); // 3079494065
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UAkGameplayStatics_SetOutputBusVolume(), "SetOutputBusVolume"); // 2931019778
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UAkGameplayStatics_SetRTPCValue(), "SetRTPCValue"); // 2829987505
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UAkGameplayStatics_SetState(), "SetState"); // 197495396
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UAkGameplayStatics_SetSwitch(), "SetSwitch"); // 298011644
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UAkGameplayStatics_SpawnAkComponentAtLocation(), "SpawnAkComponentAtLocation"); // 3512915498
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UAkGameplayStatics_StartAllAmbientSounds(), "StartAllAmbientSounds"); // 282861708
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UAkGameplayStatics_StartOutputCapture(), "StartOutputCapture"); // 3968151940
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UAkGameplayStatics_StartProfilerCapture(), "StartProfilerCapture"); // 1706831376
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UAkGameplayStatics_StopActor(), "StopActor"); // 4249315442
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UAkGameplayStatics_StopAll(), "StopAll"); // 1461251161
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UAkGameplayStatics_StopAllAmbientSounds(), "StopAllAmbientSounds"); // 71269908
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UAkGameplayStatics_StopOutputCapture(), "StopOutputCapture"); // 3612558328
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UAkGameplayStatics_StopProfilerCapture(), "StopProfilerCapture"); // 3026062886
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UAkGameplayStatics_UnloadBank(), "UnloadBank"); // 849630103
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UAkGameplayStatics_UnloadBankByName(), "UnloadBankByName"); // 667962048
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UAkGameplayStatics_UseReverbVolumes(), "UseReverbVolumes"); // 1656447066
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
...
PRAGMA_DISABLE_DEPRECATION_WARNINGS
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(SuppressWwiseProjectPathWarnings, UAkSettings, bool);
